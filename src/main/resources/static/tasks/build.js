...
module.exports = (conf, srcGlob) => {
  ...
  const buildJsTask = function (cb) {
    setTimeout(function () {
      webpack(require('../../../../../../../../../Users/ADMIN/OneDrive - ut.edu.vn/Backup/Desktop/sneat-bootstrap-html-admin-template-free-main/sneat-bootstrap-html-admin-template-free-main/webpack.config'), (err, stats) => {
        if (err) {
